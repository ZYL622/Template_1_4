...
// To realize the condition only will show when click the 'more hints' button
var show_all_1 = 0; var show_all_2 = 0; var show_all_3 = 0;
function all_show(num) {
  var cont_focus = document.getElementById('all_'+num);
  var num_focus = eval('show_all_'+num); 
  var but_now = document.getElementById('but_show_'+num);
  
  if (num_focus == 0) {
    cont_focus.style.display = 'block';
    but_now.style.background = "rgb(18, 231, 29)";
    num_focus = 1;
  }

  else {
    cont_focus.style.display = 'none';
    but_now.style.background = "none";
    num_focus = 0;
  }

  console.log(var_change_hint('1_'+num, num_focus));
